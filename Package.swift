...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "MTAnalytics",
            url: "https://packages.a.mts.ru/repository/apple-sdk/ios-sdk/build/MTAnalytics-6.5.0.zip",
            checksum: "912417bcd2ad6c4b6b86304efad471e3769cdf13241ca3628eb7337973c1a6dd"
         )
    ]
)
